...
class DataBaseTest extends TestCase
{
    ...
    public function test_database_creation_end_tables_exists()
    {
        ...
        $this->assertTrue(Schema::hasTable('breeds'), 'breeds tábla nem létezik');
        $this->assertTrue(Schema::hasTable('medicines'), 'medicines tábla nem létezik');
        $this->assertTrue(Schema::hasTable('colors'), 'colors tábla nem létezik');
        $this->assertTrue(Schema::hasTable('dogs'), 'dogs tábla nem létezik');
        $this->assertTrue(Schema::hasTable('photos'), 'photos tábla nem létezik');
        $this->assertTrue(Schema::hasTable('vaccinations'), 'vaccinations tábla nem létezik');
